...
function activate(context) {
    ...
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('halloween.enableEffects', () => {
        enableEffects(context);
    }));
    context.subscriptions.push(vscode.commands.registerCommand('halloween.disableEffects', () => {
        disableEffects();
    }));
    context.subscriptions.push(vscode.commands.registerCommand('halloween.toggleEffects', () => {
        if (isEnabled) {
            disableEffects();
        }
        else {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('halloween.openDemo', () => {
        openDemo(context);
    }));
    ...
    vscode.window.showInformationMessage('🎃👻 Halloween activated! Theme + Icons + Effects all-in-one! 🦇', 'Enable Effects', 'Open Demo').then(selection => {
...
function enableEffects(context) {
    isEnabled = true;
    if (effectsPanel) {
        effectsPanel.reveal();
        return;
    ...
    effectsPanel = vscode.window.createWebviewPanel('halloweenEffects', '🎃 Halloween Haunted Effects 👻', vscode.ViewColumn.One, {
        enableScripts: true,
...
function openDemo(context) {
    const panel = vscode.window.createWebviewPanel('halloweenDemo', '🎃 Halloween Effects Demo 👻', vscode.ViewColumn.One, {
        enableScripts: true,
        retainContextWhenHidden: true
    });
