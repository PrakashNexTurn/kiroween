...
class TestInstructionGenerator:
    ...
    def test_generate_spec_instruction_requirements(self):
        ...
        spec_dir = "/base/test-project/.kiro/specs"
        ...
        assert spec_dir in instruction
    ...
    def test_generate_spec_instruction_design(self):
        ...
        project_id = "my-app"
        spec_dir = "/base/my-app/.kiro/specs"
    ...
    def test_generate_spec_instruction_tasks(self):
        ...
        project_id = "todo-app"
        spec_dir = "/base/todo-app/.kiro/specs"
    ...
    def test_generate_task_instruction_specific_task(self):
        ...
        spec_dir = "/base/my-project/.kiro/specs"
        ...
        assert spec_dir in instruction
        assert project_root in instruction
        assert "tasks.md" in instruction
    ...
    def test_generate_task_instruction_all_tasks(self):
        ...
        spec_dir = "/base/full-project/.kiro/specs"
        project_root = "/base/full-project"
    ...
    def test_generate_build_instruction(self):
        ...
        project_root = "/base/build-test"

        instruction = self.generator.generate_build_instruction(project_id, project_root)
    ...
    def test_generate_test_instruction(self):
        ...
        project_id = "test-project"
        project_root = "/base/test-project"

        instruction = self.generator.generate_test_instruction(project_id, project_root)
    ...
    def test_generate_fix_instruction(self):
        ...
        project_root = "/base/buggy-project"
        failure_details = (
    ...
    def test_all_instructions_start_with_trust_all(self):
        ...
        project_id = "test"
        spec_dir = "/base/test/.kiro/specs"
        project_root = "/base/test"

        instructions = [
            self.generator.generate_spec_instruction(project_id, spec_dir, "requirements", "desc"),
            self.generator.generate_spec_instruction(project_id, spec_dir, "design", "desc"),
            self.generator.generate_spec_instruction(project_id, spec_dir, "tasks", "desc"),
            self.generator.generate_task_instruction(project_id, spec_dir, project_root, "1.1"),
            self.generator.generate_task_instruction(project_id, spec_dir, project_root, None),
            self.generator.generate_build_instruction(project_id, project_root),
            self.generator.generate_test_instruction(project_id, project_root),
            self.generator.generate_fix_instruction(project_id, project_root, "failures"),
        ]
